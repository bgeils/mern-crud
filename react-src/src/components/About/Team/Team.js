...
import brendon from '../../../media/bgeils.jpg';
...
class Team extends Component {
	...
	render(){
		...
		return (
			...
			<Card.Group>
			<Card>
			  <Image src={brendon} className="team-pic" />
			    <Card.Content>
			      <Card.Header> Brendon Geils</Card.Header>
			      <Card.Meta>Founder. Joined in 2016</Card.Meta>
			...
			<Card>
			  <Image src='http://sdmay18-41.sd.ece.iastate.edu/images/ArunSondhi.jpg' className="team-pic"/>
			    <Card.Content>
			      ...
			      <Card.Meta>Embedded Engineer. Joined in 2017</Card.Meta>
		    ...
		    <Card>
			  <Image src={alec} className="team-pic" />
			    <Card.Content>
			      ...
			      <Card.Meta>Software Engineer. Joined in 2017</Card.Meta>
		    ...
		    <Card>
			  ...
			  <Image src='http://sdmay18-41.sd.ece.iastate.edu/images/jack.png' className="team-pic" />
			    <Card.Content>
			      ...
			      <Card.Meta>Hardware Engineer. Joined in 2017</Card.Meta>
